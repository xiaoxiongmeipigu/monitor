...
public class LiveActivity extends Activity implements OnClickListener, OnCheckedChangeListener, Callback, LiveCallBack {
    ...
    private void initData() {
        ...
        Toast.makeText(this, "cameraID:"+cameraInfo.cameraID, Toast.LENGTH_LONG).show();
...
//       Toast.makeText(this, "addr:"+Config.getIns().getServerAddr()+",sid:"+TempData.getIns().getLoginData().sessionID+",mDeviceID:"+mDeviceID, Toast.LENGTH_LONG).show();
        if (ret && deviceInfo != null) {
            mName = deviceInfo.userName;
            mPassword = deviceInfo.password;
//            Toast.makeText(this, "mName:"+mName+",mPassword:"+mPassword, Toast.LENGTH_LONG).show();
        } else {
            mName = "admin";
            mPassword = "12345";
        }
