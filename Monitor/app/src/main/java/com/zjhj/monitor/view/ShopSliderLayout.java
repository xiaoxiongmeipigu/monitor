...
import com.zjhj.monitor.adapter.ShopPagerAdapter;
 ...
 */
public class ShopSliderLayout extends RelativeLayout {
    ...
    public ShopSliderLayout(Context context) {
        super(context);
        mContext = context;
        initView();
    }

    public ShopSliderLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }

    public ShopSliderLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        if (isInEditMode())
            return;
        view = LayoutInflater.from(mContext).inflate(R.layout.layout_shop_slider, this);
